...
namespace HzzGrader
{
    public static class MainExternalTestcaseHandler
    {
        ...
        public static readonly string testcase_local_dir =
            Path.Combine(AppDomain.CurrentDomain.BaseDirectory, "testcases");

        public static readonly string testcase_local_version_filename = "version";


        public static async Task initial_caching(){
            // automatically caching the main root and it's first and last children
            try{
                ...
                MainWindow.write_log("initial caching failed: " + e.Message + "\n\n" + e.StackTrace);
            }
        }
        ...
        public static async Task on_sub_dir(string total_path, Action<bool, string, string> on_done,
            ...
            download_testcase_window = new DownloadTestcaseWindow(file_names, on_select, true,
                DownloadTestcaseWindow.WINDOW_POS_AS_MAIN_WINDOW);
            download_testcase_window.Show();
            download_testcase_window.Activate();
        }

        public static async Task on_choose_testcase(string total_path, string version,
            Action<bool, string, string> on_done,
            Action<Exception> on_error){
