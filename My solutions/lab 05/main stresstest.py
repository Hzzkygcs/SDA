...
def generate_soal__():  # use randint() (or other random func) and print()
    taken_name = set()
    banyak_kotak_awal = randint(1, 70)
    ...
    while banyak_query > 0:
        ...
        if tipe_query == "STOCK":
            ...
            harga_1 = random_harga_tipe()[0]
            harga_2 = random_harga_tipe()[0]
...
def generate_soal_tipe_pasti_beda():  # tipe pasti dijamin berbeda
    tipe_counter = 1
    taken_name = set()
    banyak_kotak_awal = randint(1, 10)
    print(banyak_kotak_awal)
