...
pisah_tc = [0] * 2 + [1] * 2 + [2] * 2 + [3] * 2 + [4] * 2 + [None] * tc_count



min_tc = min_hari = min_event = 1
max_tc = 2
min_orang = None
max_orang = 10
max_hari = 5
...
##                               min(2 + nomor_soal**2 + tc, max_orang))
        ...
        kode_evaluasi_akhir = pisah_tc[nomor_soal]
        if (kode_evaluasi_akhir is None):
            kode_evaluasi_akhir = randint(0, 4)
